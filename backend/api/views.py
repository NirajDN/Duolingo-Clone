...
def register_user(request):
    ...
    LeaderboardEntry.objects.get_or_create(user=user, defaults={'league': ACTIVE_LEAGUE})
...
def get_leaderboard(request):
    ...
    return Response(build_leaderboard_payload(limit=20))
